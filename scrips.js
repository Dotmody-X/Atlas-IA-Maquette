...
function ac(){ cx+=(tx-cx)*.16; cy+=(ty-cy)*.16; CUR.style.transform=`translate(${cx}px,${cy}px)`; requestAnimationFrame(ac); }
ac();
...
const VERSIONS = [
  {
    num:'V1', name:'Landing Classic', style:'Dark · Teal · Glassmorphism',
    path:'v1/index.html', tag:'Dark', tagColor:'#0A9396',
    desc:'Premier proto — fond sombre teal, glassmorphisme, console animée.'
  },
  {
    num:'V2', name:'Proto Style — Ivory', style:'Ivory · Teal · Serif',
    path:'v2/index.html', tag:'Light', tagColor:'#0A9396',
    desc:'Direction inspirée du proto existant — Instrument Serif, palette crème.'
  },
  {
    num:'V3', name:'Instrument Serif', style:'Ivory · Teal · Editorial',
    path:'v3/index.html', tag:'Editorial', tagColor:'#94D2BD',
    desc:'Typographie Instrument Serif, mise en page bento structurée.'
  },
  {
    num:'V4', name:'Glass Apple', style:'Beige chaud · Orange · Glass',
    path:'v4/index.html', tag:'Glass', tagColor:'#E9C46A',
    desc:'Glassmorphisme Vision Pro — ambre chaud, blur, coins arrondis.'
  },
  {
    num:'V5', name:'Gris Souris', style:'Gris souris · Bleu · Mono',
    path:'v5/index.html', tag:'Grey', tagColor:'#0404e9',
    desc:'Palette gris chaud, bento grid, typographie Syne + DM Mono.'
  },
  {
    num:'V6', name:'3D Objects + Orange', style:'Gris · Orange · 3D CSS',
    path:'v6/index.html', tag:'3D', tagColor:'#f06400',
    desc:'Objets 3D CSS flottants, touches de clavier interactives, curseur custom.'
  },
  {
    num:'V7', name:'Dark Tech Bebas', style:'Noir · Orange · Bebas Neue',
    path:'v7/index.html', tag:'Dark', tagColor:'#f06400',
    desc:'Bebas Neue massive, watermark géant, objets 3D avec parallaxe souris.'
  },
  {
    num:'V8', name:'Editorial Doux', style:'Crème · Coral · Cormorant',
    path:'v8/index.html', tag:'Soft', tagColor:'#d45a3a',
